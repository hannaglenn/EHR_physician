...
Since this is also a demand-driven variable as well, I investigate whether any external factors may shift the demand for health care over the sample period. 
...
\begin{figure}[p]
    ...
    \includegraphics[scale=.4]{Objects/patient2_plot.pdf}
    \label{fig:patient2}
\end{figure}
