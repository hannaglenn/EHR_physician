...
\centering
    ...
    \includegraphics[scale=.65]{Objects/sum_stats_year.pdf}
...
Before I present these estimators, I present results from a two way fixed effects setup that may suffer bias from negative weighting. These results from each outcome are presented in 
