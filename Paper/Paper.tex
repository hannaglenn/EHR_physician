...
\centering
   ...
   \includegraphics[width=0.8\textwidth]{retire_plot_ages}
   \caption{}
   \label{fig:Ng1} 
\end{subfigure}
...
\begin{figure}[ht!]
    ...
    \includegraphics[scale=.5]{Objects/retire_plot.pdf}
...
\begin{figure}[ht]
    ...
    \includegraphics[scale=.5]{Objects/officeind_plot.pdf}
...
\begin{figure}[ht]
    ...
    \includegraphics[scale=.5]{Objects/officefrac_plot.pdf}
...
\begin{figure}[ht]
    ...
    \includegraphics[scale=.5]{Objects/patient_plot.pdf}
    \label{fig:patient}
    \vspace{2mm}
...
\begin{figure}[ht]
    ...
    \includegraphics[scale=.5]{Objects/claim_per_patient_plot.pdf}
    \label{fig:claim}
    \vspace{2mm}
