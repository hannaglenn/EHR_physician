...
\hspace{1em}Capital Expenses (Buildings) & 88,036 & 176,287\\
\hspace{1em}Capital Expenses (Equipment) & -96,304 & 184,225\\
\hspace{1em}Expenses w/out Med. Records & 17,385,718 & 8,106,164\\
\hspace{1em}Owns Subsidiary & -0.02 & 0.02\\
\hspace{1em}Change Admin & 0.01 & 0.02\\
\hspace{1em}No. Beds & 0.28 & 2.15\\
\addlinespace[0.3em]
\multicolumn{3}{l}{\textbf{Workforce}}\\
\hspace{1em}No. Nurses & 2.66 & 5.33\\
